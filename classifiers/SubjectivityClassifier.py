...
from subjectivity_common import build_model

CLASSIFIERS_DIR = Path(__file__).resolve().parent
MODELS_DIR = CLASSIFIERS_DIR / "models"
DEFAULT_MODEL_PATH = MODELS_DIR / "subjectivity_model.joblib"

class SubjectivityClassifier(BaseEstimator, ClassifierMixin):
    def __init__(self):
